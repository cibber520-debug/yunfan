...
export const config = {
  ...
  db: {
    ...
    max: Math.max(1, intEnv('PG_POOL_MAX', 10)),
    connectionTimeoutMs: Math.max(1_000, intEnv('PG_CONNECTION_TIMEOUT_MS', 8_000)),
    queryTimeoutMs: Math.max(1_000, intEnv('PG_QUERY_TIMEOUT_MS', 10_000)),
    statementTimeoutMs: Math.max(1_000, intEnv('PG_STATEMENT_TIMEOUT_MS', 10_000)),
    lockTimeoutMs: Math.max(1_000, intEnv('PG_LOCK_TIMEOUT_MS', 5_000)),
    idleTimeoutMs: Math.max(1_000, intEnv('PG_IDLE_TIMEOUT_MS', 30_000)),
    initLockTimeoutMs: Math.max(1_000, intEnv('PG_INIT_LOCK_TIMEOUT_MS', 15_000)),
    initStatementTimeoutMs: Math.max(1_000, intEnv('PG_INIT_STATEMENT_TIMEOUT_MS', 20_000)),
  },
  auth: {
